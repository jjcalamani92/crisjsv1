...
import { FolderOpenOutlined, AppstoreOutlined } from '@ant-design/icons';
      ...
      <div className="w-full h-full bg-gray-200">
        <div className="lg:flex flex-no-wrap">
          ...
          <div className="absolute lg:relative w-64 h-screen shadow bg-gray-100 hidden lg:block">
            ...
            <ul className=" py-6">
              <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 pt-5 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => push('/dashboard')}>
                <div className="flex items-center">
                <AppstoreOutlined style={{ fontSize: '20px' }}/>
                  <span className="ml-2">Dashboard</span>
                </div>
              </li>
              <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal pb-4 pt-5 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none" onClick={() => push('/dashboard/sites')}>
                <div className="flex items-center">
                      ...
                      <div className="rounded-full">
                        {profile ? (
                          <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                            ...
                            <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2" onClick={() => signOut({ callbackUrl: "/" })}>
                              <div className="flex items-center">
